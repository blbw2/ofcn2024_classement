...
On calcule soit un score "brut" comme somme des scores par variables, soit un score pondéré.

  - Pour l'instant la pondération : 0.5 x PIB ; 0.2 x Chomage ; 0.2 x Solde; 0.1 x IPCH
...
- Classement par ordre croisssant d'erreur de prévision (en valeur absolue).

- Prévisions manquantes: on impute la valeur de la pire prévision.

- J'ai ajouté une colonne "Total" qui fait la moyenne des classements par variable
...
PIB +1.1% ; Chomage 7.5% (fin d'année) ; IPCH +4.2% (fin d'année) ; Solde public -5.5%
```{r}
prev2022 |> 
